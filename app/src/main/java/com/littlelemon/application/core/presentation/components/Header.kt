...
fun Header(
    ...
    Row(
        modifier = modifier
            .fillMaxWidth()
            .padding(vertical = MaterialTheme.dimens.sizeLG), verticalAlignment = Alignment.CenterVertically,
    ) {
        Text(label, style = style, color = MaterialTheme.colors.contentPrimary, modifier = Modifier.weight(1f))
